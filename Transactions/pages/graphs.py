...
PaymentStatus = st.selectbox(
    "What Payment Status", ("All", "Charge", "Refund", "Chargeback")
)

PaymentMethod = st.selectbox(
    "What Payment Method", ("All", "Goods and Services", "Friends & Family")
)

PaymentApplication = st.selectbox(
    "What Payment Status", ("All", "Desktop", "Tablet", "Phone")
)
...
tab1, tab2, tab3, tab4 = st.tabs(
    ["Histogram", "Box/Whiskey", "Box Plot Sum", "Box Plot Count"]
)
